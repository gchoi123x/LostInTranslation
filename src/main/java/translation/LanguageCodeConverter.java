    ...
    public LanguageCodeConverter(String filename) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                String[] languageNamePair = line.split("\t");
                System.out.println(languageNamePair[0]);
                System.out.println(languageNamePair[1]);
                languageCodeToLanguage.put(languageNamePair[1], languageNamePair[0]);
                languageToLanguageCode.put(languageNamePair[0], languageNamePair[1]);
            }
